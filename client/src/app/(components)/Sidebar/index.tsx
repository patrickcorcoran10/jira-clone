        ...
        <div className={sidebarClassNames}>
            <div className='flex h-[100%] w-full flex-col justify-start'>
                ...
                <div className='flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700'>
                    ...
                    <div>
                        <h3 className='text-md font-bold tracking-wide dark:text-gray-200'>Pat's Team</h3>
...
const SideBarLink = ({
    ...
    return (
        <Link href={href} className='w-full'>
            <div className={`relative flex curso-pointer items-center gap-3 transition-colors hover:bg-gray-100 dark:bg-black dark:hover:bg-gray-700 ${
                isActive 
